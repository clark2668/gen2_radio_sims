...
# time to slice and dice (shake and bake? same difference?)
...
for flavor in flavors:
    ...
    for logE in logEs:
        ...
        for result in pool_result:
            ...
            combined_hybrid_only_veff_bins[zen_bin] += result['hybrid_only_weight']/result['n_events'] * result['volume']
            ...
            combined_hybrid_only_veff += result['hybrid_only_weight']/result['n_events'] * result['volume']
        ...
        total_veff[f"{logE:.1f}"]['hybrid_only_veff'] = gwe(combined_hybrid_only_veff/num_zen_bins)
        ...
        total_veff[f"{logE:.1f}"]['hybrid_only_veff_zen_bins'] = gwe(combined_hybrid_only_veff_bins)
