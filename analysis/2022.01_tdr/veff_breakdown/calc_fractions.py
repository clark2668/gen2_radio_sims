...
for flavor in flavors:
    ...
    for logE in logEs:
        ...
        total_veff[f"{logE:.1f}"]['deep_only_veff'] = gwe(combined_deep_only_veff/num_zen_bins)
        ...
        total_veff[f"{logE:.1f}"]['deep_only_veff_zen_bins'] = gwe(combined_deep_only_veff_bins)
