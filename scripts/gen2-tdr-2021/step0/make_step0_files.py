...
import helper_gen2_tdr_2021 as hp
...
# these are the fiducialization settings
# that give ~5km clearance on from the edge of the largest
# array under consideration (the shallow heavy design)
