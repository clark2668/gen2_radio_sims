...
for flavor in flavors:
    file = "times_" + detector + "_array_"+ flavor + "_v2.txt"
...
for flavor in flavors:
    file = "triggers_" + detector + "_array_"+ flavor + "_v2.txt"
    with open(file) as fp:
        line = fp.readline()
        while line:
            split_line = line.strip().split(':')
...
numruns_e = np.divide(desired_events, times_e)
numruns_mu = np.divide(desired_events, times_mu)
numruns_tau = np.divide(desired_events, times_tau)

print("e events: {}".format(times_e[1][:]))
print('------')
print("e runs: {}".format(numruns_e[1][:]))
print('------')
print('------')
print('------')

print("mu events: {}".format(times_mu[1][:]))
print('------')
print("mu runs: {}".format(numruns_mu[1][:]))
print('------')
print('------')
print('------')
print("tau events: {}".format(times_tau[1][:]))
print('------')
print("tau runs: {}".format(numruns_tau[1][:]))
...
# and plot number of events per run to fit in assumed hours
for flavor in flavors:
    ...
    fig.savefig("predicted_num_evts_per_run_{}m_{}_v2.png".format(detector, flavor),edgecolor='none', bbox_inches='tight')
...
fig.savefig("time_per_event_{}_v2.png".format(detector),edgecolor='none', bbox_inches='tight')
...
fig.savefig("counts_{}_v2.png".format(detector),edgecolor='none', bbox_inches='tight')
