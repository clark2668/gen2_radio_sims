...
step4dir = "/data/sim/Gen2/radio/2020/gen2-tdr-2021/simulation_output/secondaries_1700km2/step4/"
...
for det_file_label in det_files_labels:
	...
	for flavor in flavors:
		...
		instructions += f'VARS job_{master_index} step3dir="{step3dir}" step4dir="{step4dir}" detfile="{det_file}" configfile="{config_file}" simfile="{sim_file}" flavor="{flavor}" \n\n'
