...
ax.plot(xxx / units.km, yyy / units.km, "C0o", label='Deep + Shallow Stations', markersize=5)
ax.plot(xxx_s / units.km, yyy_s / units.km, "C1D", label='Shallow-only Stations', markersize=3)
ax.set_xlabel("X [km]")
ax.set_ylabel("Y [km]")
ax.set_aspect("equal")
