...
output_csv += 'This is reasonably close to the 1:1.17 ratio in the review array, but is not exact.\n'
...
output_csv += 'But you should not trust that formula for n_deep == n_shallow, because that is NOT what was simulated. It needs to be ~1:1.1\n'
output_csv += "------\n"
output_csv += 'log10(energy) [eV], deep veff*sr [km^3sr], deep aeff*sr [km^2sr], shallow veff*sr [km^3sr], shallow aeff*str [km^2sr], overlap fraction\n'
for iE, energy in enumerate(energies):
	output_csv += '{:.1f}, {:e}, {:e}, {:e}, {:e}, {:.3f} \n'.format(np.log10(energy), deep_veff[iE], deep_aeff[iE], shallow_veff[iE], shallow_aeff[iE], overlap_fractions[iE])
