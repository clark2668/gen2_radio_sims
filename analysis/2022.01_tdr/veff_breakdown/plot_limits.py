...
ax_aeff.plot(*helper.stepped_path(optical_energies, optical_aeff),
    linewidth=2,
    label='Gen2-Optical EHE, Analysis Level'
    )

ax_veff[0].plot(*helper.stepped_path(optical_energies, optical_veff))
...
print( limit_optical/limits.plotUnitsFlux)
